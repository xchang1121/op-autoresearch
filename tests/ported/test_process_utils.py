...
from op_autoresearch.core.worker import eval_config  # noqa: E402
from op_autoresearch.utils import process_utils as pu  # noqa: E402
...
def test_communicate_or_kill_timeout_returns_flag(monkeypatch):
    monkeypatch.setenv("OP_AUTORESEARCH_EVAL_KILL_GRACE_S", "0.5")
    from op_autoresearch.utils.process_utils import communicate_or_kill as _communicate_or_kill
