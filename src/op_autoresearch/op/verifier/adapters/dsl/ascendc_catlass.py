...
class DSLAdapterAscendC_Catlass(DSLAdapter):
    ...
    def get_special_setup_code(self, framework: str = "torch") -> str:
        ...
        try:
            from op_autoresearch.op.utils.catlass_paths import resolve_catlass_root as _resolve_catlass_root
        except Exception:
        ...
        if not _catlass_root:
            raise RuntimeError(
                ...
                "export CATLASS_ROOT, or install catlass at <op_autoresearch-root>/thirdparty/catlass "
