...
class DSLAdapter(ABC):
    ...
    def create_impl_module(self, framework: str,
        ...
        """Generates the code for creating impl_mode (DSL for ModelNew-type format).

        For DSL using ModelNew format (e. g. Triton_cuda, Triton_ascend, cpp),
        Pre-example model is required. For function DSL, return empty string.
        ...
        """
        return ""  # The default returns an empty string, the DSL in ModelNew format requires override
